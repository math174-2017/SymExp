...
# or set MAX_FD != -1 to use that value.
MAX_FD="maximum"
...
# For Darwin, add options to specify
# how the application appears in the dock
if $darwin; then
...
if $cygwin ; then
    ...
    # We build the pattern for arguments 
    # to be converted via cygpath
